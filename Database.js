class Database {
    ...
    FUEL_CONSUMPTION = [
       /*Boeing 737-800*/ [1715, 3494, 4621, 6221, 7749, 10666, 13460, 16170, 18818, 21415, 23972], //This line corresponds to LIST_OF_PLANES[0], aka "Boeing 737-800". The numbers are pulled from https://www.icao.int/environmental-protection/CarbonOffset/Documents/Methodology%20ICAO%20Carbon%20Calculator_v10-2017.pdf
        ...
        /*Embraer E175 Vi skal snakke om hvad der skal ske hvis flyet ikke er på ICAO listen*/
    ];
    ...
    NUMBER_OF_Y_SEATS = [162, 141, 96, 176, 200, 160, 177]; //The position in this array corresponds to LIST_OF_PLANES. Y_Seats = economy seats
    ...
    KM_PER_HOUR = [842, 828, 840, 833, 850, 828, 925]; ////The position in this array corresponds to LIST_OF_PLANES. Enter the cruise speed of the aircraft
