class Database {
    ...
    LIST_OF_PLANES = ["Boeing 737-800", "Boeing 737-700", "Airbus A320", "Airbus A321", "Boeing 757-200", "Airbus A319", "Boeing 737-900ER", "Embraer E175", "Canadair (Bombardier) Regional Jet 900", "Canadair (Bombardier) Regional Jet 700", "Airbus A319", "Airbus A320-100/200", "Embraer 190", "Airbus A320neo"]; //List of the most used Aircrafts http://www.fi-aeroweb.com/US-Commercial-Aircraft-Fleet.html
    ...
    FUEL_CONSUMPTION = [
        ...
        /*Embraer 190*/ [1338, 2688, 3567, 4695, 5778, 7871, 9913],
        /*Airbus A320neo*/ [1672, 3430, 4585, 6212, 7772, 10766, 13648, 16452],
    ];
    ...
    NUMBER_OF_Y_SEATS = [162, 141, 96, 176, 200, 160, 177, 90, 68, 140, 192, 95, 174 ]; //The position in this array corresponds to LIST_OF_PLANES. Y_Seats = economy seats
    ...
    KM_PER_HOUR = [842, 828, 840, 833, 850, 828, 925, 830, 829, 828, 842, 829, 840 ]; ////The position in this array corresponds to LIST_OF_PLANES. Enter the cruise speed of the aircraft
