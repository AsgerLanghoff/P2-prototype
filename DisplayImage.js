    ...
    displayBar() {
        ...
        for (let i = 0; i < elements.length; i++) {
            ...
            $(e).find(".left-column").first().append(
                ...
                '<img src="chrome-extension://kfanbomikhoiibhgbjpjkgpkgdnejonf/data/information.png" alt="information" class="informationIcon" id="informationIcon">' +
                ...
                '<img src="chrome-extension://kfanbomikhoiibhgbjpjkgpkgdnejonf/data/pointer.png" alt="pointer" class = "showPointerInner" id = "pointerInner"> ' +
                ...
                '<hr class="bottomLine">' +
                '<p class="bottomText"> <img id="bottomIcon" src="chrome-extension://kfanbomikhoiibhgbjpjkgpkgdnejonf/data/logo.png">Læs mere i popup menuen øverste i hjørnet af din browser</p>' +
                '</section>' +
                '</div>'+
                '<div> <br> <br> </div>' );
            }
